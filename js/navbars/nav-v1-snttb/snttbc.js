const NAVBAR_TOGGLER = document.querySelectorAll("[data-js-trigger='snttbc-navbar-toggler']");
const DROPDOWN_MENU_CONTAINER = document.querySelectorAll("[data-js-trigger='snttbc-dropdown-container']");
...
const addOverflowYToExpandedNavbar = () => {
  const checkbox = document.querySelectorAll("[data-js-trigger='snttbc-navbar-toggler-checkbox']").item(0);
  const navbarContainer = document.querySelectorAll("[data-js-trigger='snttbc-navbar-container']").item(0);
...
const preventDefaultInDropdownAnchorTag = () => {
  const dropdownContainer = document.querySelectorAll("[data-js-trigger='snttbc-dropdown-container']").item(0);
  const dropdownToggler = document.querySelectorAll("[data-js-trigger='snttbc-dropdown-toggler']").item(0);
...
const makeNavbarAccessibleByKeystrokes = () => {
  var navbarTogglerCheckbox = document.querySelectorAll("[data-js-trigger='snttbc-navbar-toggler-checkbox']").item(0);
